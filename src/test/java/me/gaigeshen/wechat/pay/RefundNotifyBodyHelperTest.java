 ...
 * @author gaigeshen
 */
public class RefundNotifyBodyHelperTest {
  @Test
  public void testDecrypt() {
    RefundNotifyBodyHelper helper = RefundNotifyBodyHelper.create(
            "<xml><return_code>SUCCESS</return_code><return_msg>OK</return_msg>" +
                    "<appid><![CDATA[wx2421b1c4370ec43b]]></appid>" +
                    "<mch_id><![CDATA[10000100]]></mch_id>" +
                    "<nonce_str><![CDATA[TeqClE3i0mvn3DrK]]></nonce_str>" +
                    "<req_info><![CDATA[m4NnwrtY0jhpDgNp65H1V/0OWMtSoTYhhY89MHbflhmnaHq9ZKjx9ABq6Jpg4SccA8" +
                          ...
                          "xvjAwujvf4HDwzHgFsmSml013U2mUiy+v4zw==]]></req_info></xml>",
            "2IBtBXdrqC3kCBs4gaceL7nl2nnFadQv");

    boolean returnFailed = helper.isReturnFailed();
    boolean returnSucceeded = helper.isReturnSucceeded();
    String returnMessage = helper.getReturnMessage();

    System.out.println("returnFailed: " + returnFailed);
    System.out.println("returnSucceeded: " + returnSucceeded);
    System.out.println("returnMessage: " + returnMessage);

    RefundNotify notify = helper.parseToObject(RefundNotify.class);
